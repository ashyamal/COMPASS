...
from conceptor.dataloader import TCGAData, GeneData, ITRPData
...
from conceptor.model.adapt import Adp_Trainer, Adp_Tester
...
class PreTrainer:
    ...
    def _setup(self, input_dim, task_dim, task_type, save_dir, run_name):
        ...
        model = Conceptor(input_dim, task_dim, task_type, 
    ...
    def load(self, mfile, **kwargs):
        self = loadconceptor(mfile, **kwargs)
        if self.with_wandb:
            self.wandb._settings = ''
        return self
