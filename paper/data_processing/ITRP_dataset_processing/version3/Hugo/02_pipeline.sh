...
work_dir=/n/data1/hms/dbmi/zitnik/lab/users/was966/ITRP/fastaq/Hugo
...
mkdir -p ${rawdata_dir} ${cleandata_dir} ${out_dir} 
...
# sbatch --mem 64G -c 20 -t 29-12:00 -p priority ./pipeline.sh
