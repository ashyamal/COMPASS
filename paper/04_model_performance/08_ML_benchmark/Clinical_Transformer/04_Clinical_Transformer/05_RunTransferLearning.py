...
# nohup /home/shenwanxiang/anaconda3/envs/IRnet_env/bin/python 05_RunTransferLearning.py > RunTransferLearning.log 2>&1 &
...
def cleanup_model_checkpoints(outdir):
    for i in range(repetitions):
        cmd = f"rm -r {outdir}/model.E002000.h5/fold-{i}_id-{i}/model.*.h5"
        os.system(cmd)
...
save_dir = './Results/ResultsTransferLearning'
